...
<body background="css/Image/background.jpg" style="background-repeat: no-repeat; background-size: 100%">
  ...
  <div class="container">
    ...
    <div class="row">
      <justify><p class="padding">Aotlie Service merupakan salah satu servis mobil yang berada di Laguboti, Toba, Sumatera Utara. Bengkel ini berdiri pada tahun 2011 yang dikelola oleh Jeremy Parasian WIbowo
        ...
        mengalami kesulihan dalam melakukan registrasi, teman-teman dapat datang ke tempat agar administrator membantu dalam melakukan registrasi.</p></justify>
    </div>
